...
var yueqi = {
	...
	onAttacked: function() {
		...
		console.log('Affected ' + hurtNum + ' damage , now hp is ' + this.hp);
	},
	attack: function(enemy) {
		var hurtNum = Math.ceil(Math.random() * 150);
		console.log(this.name + ' use ' + this.weapon + ' attack ' + enemy + ' ' + hurtNum + " damage.");
	}
}
...
var yuejinzhao = function(){
	...
	function attack(enemy){
		var hurtNum = Math.ceil(Math.random() * 150);
		console.log(name + ' use ' + weapon + ' attack ' + enemy + ' ' + hurtNum + " damage.");
	}
	return {
		attack:attack
	}
